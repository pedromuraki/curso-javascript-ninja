(function() {
	...
	*/
	...
	console.log( text.replace(/Manuel Marques de Sousa/, 'Pedro Muraki') );
	...
	*/
	...
	function getMonthNumber(month) {
		...
		var monthNumber = String(months.indexOf(month) + 1);
	...
	*/
	...
	(function replaceDate() {
		console.log(
			text.replace( regexDate, function(regex, day, month, year) {
