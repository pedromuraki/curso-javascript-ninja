...
carro.addPessoas = function(pessoas) {
  ...
  if ( carro.quantidadePessoas < 5 && totalPessoas <= 5 ) {
    ...
    var assentosVazios = carro.assentos - carro.quantidadePessoas;
    var sufixoAssentos = assentosVazios > 1 ? ' pessoas!' : ' pessoa!'
    return 'Só cabem mais ' + assentosVazios + sufixoAssentos;
  }
